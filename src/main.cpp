...
int main()
{
    ...
    scene.AddPointLight(PointLight(glm::vec3(0.0f), glm::vec3(1.0f), 15.0f, 2.0f));
    scene.AddPointLight(PointLight(glm::vec3(-0.5f, 1.0f, -7.0f), glm::vec3(0.3f, 0.3f, 1.0f), 5.0f, 3.0f));
