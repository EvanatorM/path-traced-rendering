...
int main()
{
    ...
    Scene scene;
    scene.AddMaterial(Material(glm::vec3(1.0f, 0.2f, 0.2f), glm::vec3(0.0f), 0.5f, 0.0f));
    ...
    scene.AddCube(Cube(glm::vec3(-2.75f, 0.0f, 0.0f), glm::vec3(0.5f, 5.0f, 5.0f), 0));
    scene.AddCube(Cube(glm::vec3(2.75f, 0.0f, 0.0f), glm::vec3(0.5f, 5.0f, 5.0f), 0));
    ...
    scene.AddQuadLight(QuadLight(glm::vec3(-0.5f, 2.499f, -0.5f), glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f), 0, glm::vec3(1.0f), 20.0f, 3.0f));
